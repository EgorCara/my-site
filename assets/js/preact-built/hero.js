(() => {
  ...
  // ns-hugo-imp:/home/eakara/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260219145709-764756ab501c/blox/shared/js/components/Icon.jsx
  var Icon = ({ svg, attributes }) => {
    if (!svg) return null;
    let decoded = String(svg).replace(/\\u003c/gi, "<").replace(/\\u003e/gi, ">").replace(/\\u0026/gi, "&").replace(/&lt;/gi, "<").replace(/&gt;/gi, ">").replace(/&quot;/gi, '"').replace(/&#34;/gi, '"').replace(/&amp;/gi, "&").trim();
  ...
  // ns-hugo-imp:/home/eakara/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260219145709-764756ab501c/blox/hero/component.jsx
  ...
  var HeroBlock = ({ content, design, _id, icon_svg }) => {
    const paddingClasses = design?.no_padding ? "" : "py-32 sm:py-48 lg:py-56";
    return /* @__PURE__ */ u2("div", { class: "relative isolate px-6 pt-14 lg:px-8", children: /* @__PURE__ */ u2("div", { class: `mx-auto max-w-2xl ${paddingClasses}`, children: [
    ...
    heroBlocks.forEach((block) => {
      ...
      if (propsData) {
        try {
          ...
          J(/* @__PURE__ */ u2(HeroBlock, { ...props }), block);
